...
### 10. Named Command Agents
- **کدکس / Codex:** برنامه‌نویسی، مسائل کامپیوتری و پژوهش قابل ردیابی
- **استودیو / Studio:** دریافت اسکرین‌شات MT5 از ورودی مجاز، بریف ویدیوساز و متن چندکاناله؛ بدون انتشار خودکار
- **منتور / Mentor:** بازبینی آموزشی، مدیریت ریسک و آماده‌سازی چک‌لیست توزیع؛ بدون ادعای مدرک یا اجرای معامله
- **اخبار / News:** دریافت تیترهای تقویم Forex Factory با زمان دریافت و هشدار بررسی مجدد
